  ...
  run: async (client, message, args, prefix, lang) => {
    try {
      if (lang == "ar") {
        ...
        if (!voiceChannel) {
          message.reply({
            content: emojis.error + " | **يجب انت تكون في غرفه صوتيه**",
            allowedMentions: {
              repliedUser: false,
            },
            ephemeral: true,
        ...
        if (!queue)
          return message.reply({
            content: emojis.error + " | **لم يتم تشغيل اي أغنيه اصلا**",
            allowedMentions: {
              repliedUser: false,
            },
            ephemeral: true,
        ...
        if (!voiceChannel) {
          message.reply({
            content: emojis.error + " | **You Have To Be On Voice Channel**",
            allowedMentions: {
              repliedUser: false,
            },
            ephemeral: true,
        ...
        if (!queue)
          return message.reply({
            content: emojis.error + " | **Thare are no music in the queue**",
            allowedMentions: {
              repliedUser: false,
            },
            ephemeral: true,
